...
export function Signin() {
  ...
  const { formattedErrors, request } = useRequest({
    data: { email, password },
    method: 'post',
    url: '/authentication-service/users/signin',
  });
      ...
      <div className="md:grid md:grid-cols-3 md:gap-6">
        <div className="md:col-span-1">
          <div className="px-4 sm:px-0">
            ...
            <p className="mt-1 text-sm text-gray-600">Login in with existing account</p>
          </div>
        </div>
            ...
            <div className="shadow overflow-hidden sm:rounded-md">
              ...
              <div className="px-4 bg-white sm:p-6 py-5">
                <div
                  className={cx(
                    'grid grid-cols-6',
                    formattedErrors['email'] !== undefined ||
                      formattedErrors['password'] !== undefined
                      ? ' gap-4'
                      : 'gap-6'
                  )}
                >
